...
network = conv_2d(network, 34, 5,strides=1,bias=True, activation='relu', weights_init=weights)
network = max_pool_2d(network, 2)
network = conv_2d(network, 66, 5,strides=1,bias=True, activation='relu', weights_init=weights)
network = conv_2d(network, 66, 5,strides=1,bias=True, activation='relu', weights_init=weights)
network = max_pool_2d(network, 2)
...
model.fit(X, Y, n_epoch=65, shuffle=True, validation_set=(X_test, Y_test),
